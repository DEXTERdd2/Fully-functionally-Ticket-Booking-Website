        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        <!-- ***** Logo Start ***** -->
                        <a href="index.aspx" class="logo">Vente<em>Tickets</em></a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-9">
                    ...
                    <p><p><a href="index.aspx">Homepage</a>, <a href="about.aspx">About</a>, 
                    ...
                    <div class="text-button">
                        <a href="event-details.aspx">Need Directions? <i class="fa fa-arrow-right"></i></a>
                    </div>
                </div>
                <div class="col-lg-3">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="like-item">
                        <div class="thumb">
                            <a href="event-details.aspx"><img src="assets/images/like-01.jpg" alt=""></a>
                            <div class="icons">
                                <ul>
                                    <li><a href="event-details.aspx"><i class="fa fa-arrow-right"></i></a></li>
                                    <li><a href="ticket-details.aspx"><i class="fa fa-ticket"></i></a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="down-content">
                            <span>Sept 10 to 14, 2021</span>
                            <a href="event-details.aspx"><h4>Wonder Land Music and Arts Festival</h4></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="like-item">
                        <div class="thumb">
                            <a href="event-details.aspx"><img src="assets/images/like-02.jpg" alt=""></a>
                            <div class="icons">
                                <ul>
                                    <li><a href="event-details.aspx"><i class="fa fa-arrow-right"></i></a></li>
                                    <li><a href="ticket-details.aspx"><i class="fa fa-ticket"></i></a></li>
                        ...
                        <div class="down-content">
                            ...
                            <a href="event-details.aspx"><h4>Big Water Splashing Festival</h4></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="like-item">
                        <div class="thumb">
                            <a href="event-details.aspx"><img src="assets/images/like-03.jpg" alt=""></a>
                            <div class="icons">
                                <ul>
                                    <li><a href="event-details.aspx"><i class="fa fa-arrow-right"></i></a></li>
                                    <li><a href="ticket-details.aspx"><i class="fa fa-ticket"></i></a></li>
                        ...
                        <div class="down-content">
                            ...
                            <a href="event-details.aspx"><h4>Tiger Dance Hip Hop Festival</h4></a>
                        </div>
                    </div>
                </div>
            </div>
